...
export namespace StrapiModel {
  ...
  export interface ContentBlock extends Omit<StrapiApi.ContentBlockResponse, "id"> { }
  export interface Event extends StrapiApi.EventResponse { }
  export interface Opportunity extends StrapiApi.OpportunityResponse { }
  export interface TwoColumnContentBlock extends StrapiApi.TwoColumnContentBlockResponse { }
}

...
export default class ServicePage {
  constructor() {
    ...
    this.address = baseSelector.find(
      ".listing--main--left--hours header strong"
    );
    this.appProcess = baseSelector
      .find(".listing--main--left--details tr")
      .nth(0)
      .find("td");
    this.cost = baseSelector
      .find(".listing--main--left--details tr")
      .nth(2)
      .find("td");
    ...
    this.email = baseSelector
      .find(".listing--main--left--contact tr")
      .nth(1)
      .find("td");
    ...
    this.requiredDocs = baseSelector
      .find(".listing--main--left--details tr")
      .nth(1)
      .find("td");
